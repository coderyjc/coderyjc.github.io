...
![img/image-20210109101555797.](img/image-20210109101555797.png)
以后在创建文件的时候可以直接选择这个模板对应的文件了

![img/image-20210109101834044.](img/image-20210109101834044.png)
![img/image-20210109101817847.](img/image-20210109101817847.png)

同样的方法创建了主配置文件`mybatis-config`

![img/image-20210109102158505.](img/image-20210109102158505.png)
### 设置在控制台上输出运行日志
