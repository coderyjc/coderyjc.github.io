...
![image-20210104163554079](img/image-20210104163554079.png)

IOC过程

![image-20210104164919877](img/image-20210104164919877.png)
...
![image-20210105160436913](img/image-20210105160436913.png)
...
![image-20210105161355902](img/image-20210105161355902.png)
- 没有接口情况，使用CGLIB动态代理

![image-20210105161457964](img/image-20210105161457964.png)
AOP（JDK动态代理）
...
![image-20210106092108559](img/image-20210106092108559.png)
切入点表达式：
...
![image-20210106104856037](img/image-20210106104856037.png)
...
![image-20210107082520535](img/image-20210107082520535.png)
比如:
...
![image-20210107083445897](img/image-20210107083445897.png)
![image-20210107083102949](img/image-20210107083102949.png)
...
![image-20210107083220682](img/image-20210107083220682.png)
#### timeout：超时时间
...
![image-20210107141845730](img/image-20210107141845730.png)2. 创建log4j2.xml 配置文件，必须是这个名字，不能是别的。
3. 把下面代码复制过去
