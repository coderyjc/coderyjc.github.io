...
![image-20201003124003629](img/image-20201003124003629.png)

然后在path中加入bin目录

![image-20201003124039883](img/image-20201003124039883.png)
必须有JAVA_HOME环境变量

![image-20201003124154240](img/image-20201003124154240.png)


出现如下内容说明安装配置正确

![image-20201003124300534](img/image-20201003124300534.png)
...
![image-20201003125645297](img/image-20201003125645297.png)
执行tree命令

![image-20201003141751034](img/image-20201003141751034.png)
...
![image-20201005130017232](img/image-20201005130017232.png)
把这个标签移动到注释外面，并为其指定一个目录，注意整个路径中不要有中文（注意斜杠的方向）

![image-20201005130249878](img/image-20201005130249878.png)
...
![image-20201005174515862](img/image-20201005174515862.png)
- 粘贴到项目的pom文件中，完成。

![image-20201005174710831](img/image-20201005174710831.png)
...
![image-20201005191515915](img/image-20201005191515915.png)
**parent（*继承*）**
...
![image-20201005182024539](img/image-20201005182024539.png)
![image-20201005182400935](img/image-20201005182400935.png)
...
![image-20201005185408817](img/image-20201005185408817.png)
然后在项目目录下直接执行`mvn test`

![image-20201005190049196](img/image-20201005190049196.png)
...
![image-20201005193028991](img/image-20201005193028991.png)

![image-20201005202342817](img/image-20201005202342817.png)
...
![image-20201005194928174](img/image-20201005194928174.png)

![image-20201005195230320](img/image-20201005195230320.png)

**点击完成**

![image-20201005201958583](img/image-20201005201958583.png)


![image-20201005202114755](img/image-20201005202114755.png)

![image-20201005223458753](img/image-20201005223458753.png)

![image-20201005224055953](img/image-20201005224055953.png)


#### web项目的创建

![image-20201005224315467](img/image-20201005224315467.png)

使用这个模板创建的web—maven项目缺少一些文件，需要自己手动加上

![image-20201005225301233](img/image-20201005225301233.png)
...
![image-20201006213012024](img/image-20201006213012024.png)
...
![image-20201006213540837](img/image-20201006213540837.png)

![image-20201006213621843](img/image-20201006213621843.png)

![image-20201006213708749](img/image-20201006213708749.png)

![image-20201006213903965](img/image-20201006213903965.png)

![image-20201006214233580](img/image-20201006214233580.png)
...
![image-20201006222251620](img/image-20201006222251620.png)
...
![image-20201006223544315](img/image-20201006223544315.png)
